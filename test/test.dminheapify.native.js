...
var dminheapify = tryRequire( resolve( __dirname, './../lib/dminheapify.native.js' ) );
var opts = {
...
tape( 'the function has an arity of 3', opts, function test( t ) {
	t.strictEqual( dminheapify.length, 3, 'has expected arity' );
	t.end();
});
...
tape( 'the function supports view offsets', opts, function test( t ) {
	...
	x0 = new Float64Array( [ 1.0, 7.0, 5.0, 3.0, 1.0, 9.0 ] );
	expected = new Float64Array( [ 1.0, 1.0, 5.0, 3.0, 7.0, 9.0 ] );
